...
function Step2Interview({ interviewData, onFinish }) {
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      if (isIntroPhase) {
        ...
        await speakTextRef.current(currentQuestion.question);
  ...
  }, [selectedVoice, isIntroPhase, currentIndex, currentQuestion, isMicOn, questions.length, userName])
...
setIsSubmitting(false)
  ...
  }, [currentQuestion, feedback, isIntroPhase, isSubmitting, timeLeft]);
